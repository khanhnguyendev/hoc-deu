 ...
 * hidden item never streams a 200 first (§7.5). Results arrive with task 5.2 (state stays null
 * here). A render helper, not a catalog component (like `renderItemPage` beside
